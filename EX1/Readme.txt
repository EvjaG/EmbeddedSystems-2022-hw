...
There are two main functions - Blue button function and thru the Tool PuTTY (recieving input).
...
Input by PuTTY - the way to instert input to our processor is by typing in the PuTTY cmd the following : -time 15:19:22
After adjusting the time to what the user wished for the program will continue couting.

Input format : -time hh:mm:ss where:  0<=hh<24 , 0<=mm<60 , 0<=ss<60.

Leagal Input: examples : -time 00:20:38 , -time 20:58:44
Ileagal Input: examples: 00:20:38 , -time 28:30:31 
